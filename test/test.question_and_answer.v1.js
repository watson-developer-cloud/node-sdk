...
describe('question_and_answer', function() {
  ...
  it('should check for missing text', function() {
    var params = {items: 5, dataset:'travel'};
  ...
  it('should generate a valid payload', function() {
    ...
    var requests = [
      {
        params: {text: question, dataset:'travel'},
        url : service_url + travel_path
      },
      {
        params: {text: question, dataset:'healthcare'},
        url : service_url + healthcare_path
      },
      {
        params: extend({dataset:'travel'}, payload),
        url : service_url + travel_path
      },
      {
        params: extend({dataset:'healthcare'}, payload),
        url : service_url + healthcare_path
      }
      ];
  ...
  it('should format the response', function(done) {
    var params = {text: question, dataset:'travel'};
