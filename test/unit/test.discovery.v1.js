    ...
    [service, service_v2016_12_15].forEach(service => {
      ...
      describe(`discovery(version_date=${service.version_date})`, function() {
        ...
        it('should perform a query', function() {
          ...
          assert.equal(req.uri.href, service.url + paths.query + '?version=' + service.version_date + '&natural_language_query=a%20question%20about%20stuff%20and%20things&filter=yesplease&count=10&sort=%2Bfield_1%2C-field_2');
          assert.equal(req.method, 'GET');
        });
      });
    });
