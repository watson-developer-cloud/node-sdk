...
const language_translator = new LanguageTranslatorV2(service);
...
describe('translate', () => {
  describe('positive tests', () => {
    ...
    test('should pass the right params to createRequest', () => {
      ...
      checkUrlAndMethod(options, '/v2/translate', 'POST');
...
describe('identify', () => {
  describe('positive tests', () => {
    ...
    test('should pass the right params to createRequest', () => {
      ...
      checkUrlAndMethod(options, '/v2/identify', 'POST');
      checkCallback(createRequestMock);
      const expectedAccept = 'application/json';
...
describe('listIdentifiableLanguages', () => {
  describe('positive tests', () => {
    ...
    test('should pass the right params to createRequest', () => {
      ...
      checkUrlAndMethod(options, '/v2/identifiable_languages', 'GET');
      checkCallback(createRequestMock);
      const expectedAccept = 'application/json';
...
describe('createModel', () => {
  describe('positive tests', () => {
    ...
    test('should pass the right params to createRequest', () => {
      ...
      checkUrlAndMethod(options, '/v2/models', 'POST');
      checkCallback(createRequestMock);
      const expectedAccept = 'application/json';
      ...
      expect(options.formData['monolingual_corpus'].data).toEqual(monolingual_corpus);
      expect(options.formData['monolingual_corpus'].filename).toEqual(monolingual_corpus_filename);
      expect(options.formData['monolingual_corpus'].contentType).toEqual('text/plain');
...
describe('deleteModel', () => {
  describe('positive tests', () => {
    ...
    test('should pass the right params to createRequest', () => {
      ...
      checkUrlAndMethod(options, '/v2/models/{model_id}', 'DELETE');
      checkCallback(createRequestMock);
      const expectedAccept = 'application/json';
      const expectedContentType = undefined;
      checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
...
describe('getModel', () => {
  describe('positive tests', () => {
    ...
    test('should pass the right params to createRequest', () => {
      ...
      checkUrlAndMethod(options, '/v2/models/{model_id}', 'GET');
      checkCallback(createRequestMock);
      const expectedAccept = 'application/json';
      const expectedContentType = undefined;
      checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
...
describe('listModels', () => {
  describe('positive tests', () => {
    ...
    test('should pass the right params to createRequest', () => {
      ...
      checkUrlAndMethod(options, '/v2/models', 'GET');
      checkCallback(createRequestMock);
      const expectedAccept = 'application/json';
      const expectedContentType = undefined;
      checkMediaHeaders(createRequestMock, expectedAccept, expectedContentType);
