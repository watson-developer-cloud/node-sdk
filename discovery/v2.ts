...
class DiscoveryV2 extends BaseService {
   ...
   * @returns {Promise<any>|void}
   */
  public updateTrainingQuery(params: DiscoveryV2.UpdateTrainingQueryParams, callback?: DiscoveryV2.Callback<DiscoveryV2.TrainingExample>): Promise<DiscoveryV2.Response<DiscoveryV2.TrainingExample>> {
    const _params = extend({}, params);
    const _callback = callback;
    const requiredParams = ['projectId', 'queryId'];
